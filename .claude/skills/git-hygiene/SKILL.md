...
name: git-hygiene
description: >
  Enforce rock-solid git practices when making commits, creating branches,
  pushing, rebasing, or performing any git operation. Use whenever the agent
  is about to run git commands, commit changes, create branches, or interact
