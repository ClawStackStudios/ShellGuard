...
1. From the Grotto, add items of any type: **login** (with username, URL, TOTP seed, and unlimited file attachments — 50 MB max per file, 500 MB quota), **secure note**, **SSH key**, or **encrypted attachment**.
