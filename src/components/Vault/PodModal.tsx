          ...
          >
            ...
            <div className="flex items-center justify-between mb-6 pb-2">
              <div className="flex items-center gap-3">
                ...
                <h3 className="text-sm font-black uppercase tracking-widest text-white">
                  {isConfirmingDelete ? "DELETE POD" : (mode === "create" ? "NEW POD" : "EDIT POD")}
                </h3>
              </div>
              <button
                type="button"
            ...
            {isConfirmingDelete ? (
              <div className="space-y-6 text-center py-4">
                <div className="w-16 h-16 rounded-full bg-rose-500/10 flex items-center justify-center text-rose-400 mx-auto mb-4 border border-rose-500/20 shadow-[0_0_30px_-5px_rgba(244,63,94,0.3)]">
                  <Trash2 size={28} />
                </div>
                ...
                <div className="flex items-center justify-between pt-6 mt-4 border-t border-slate-800/80">
                  ...
                  <button
                    ...
                    className="px-6 py-2.5 bg-rose-500 hover:bg-rose-600 text-white font-black rounded-xl text-xs uppercase tracking-wider shadow-lg shadow-rose-500/25 transition-all cursor-pointer active:scale-95"
                  >
                    YES, DELETE
                  </button>
                </div>
