...
> **Pair With:** `.clinerules/git-hygiene.md` and `.clinerules/memory-bank/`.

---

## 🛑 Step 1: Pre-Flight Context Alignment
Before writing a single line of code, you MUST establish context:
1. Read `.clinerules/memory-bank/activeContext.md` to understand the current work focus and recent changes.
2. Read `.clinerules/memory-bank/systemPatterns.md` or related architectural docs (`attractorBeacon.md`) if the task touches core state or logic.
