...
1. From the Grotto, add items of any type: **login** (with username, URL, TOTP seed, and unlimited file attachments — 500 MB max per file, 1000 MB quota), **secure note**, **SSH key**, or **encrypted attachment**.
...
3. Organize pearls into color-coded **pods** (nested as deep as you like) and multi-dimensional **tags**.
