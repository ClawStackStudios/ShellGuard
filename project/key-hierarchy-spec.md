...
```mermaid
flowchart TD
    HU["🔐 hu- key<br/>HUMAN ROOT MASTER<br/>hu- + 64 hex (67 chars)"]
    ...
    AUTH --> TOKEN["🎫 api- token<br/>SHORT-LIVED SESSION BEARER<br/>api- + 32 hex"]

    HU --> MINT["mint (requireHuman)"]
    MINT --> LB["🦞 lb- key<br/>AGENT-SCOPED<br/>lb- + 64 hex"]
