...
> **Pair With:** `.clinerules/docs-hygiene.md`, `.clinerules/workflows/learn.md`, and `.clinerules/git-hygiene.md`.

---

## 🔒 Step 1: The Three-Layer Verification Gate
You must absolutely verify the integrity of the codebase before declaring a task complete.
Run the following in the terminal:
```bash
# 1. Syntax & Type Integrity
npm run lint

# 2. Oracle Verification (All suites must pass)
npm run test
...
1. Open `.clinerules/memory-bank/activeContext.md` and slide the "Recent Changes" window to include a summary of this task, keeping only the 10 most recent entries.
2. Log any significant new learnings, patterns, or resolved roadblocks into `.clinerules/memory-bank/raw_reflection_log.md`.
